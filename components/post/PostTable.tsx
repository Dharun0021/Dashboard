import {Table,TableBody,TableHead,TableCell,TableRow,TableHeader,TableCaption} from '@/components/ui/table'
import Link from 'next/link'
import posts from '@/data/posts';
import { Post } from '@/types/Posts';

interface PostTablePorps{
    limit?:number,
    title:string;
}

   export const PostTable = ({limit,title}:PostTablePorps) => {
