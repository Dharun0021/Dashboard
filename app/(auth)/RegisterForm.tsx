...
const formSchema = z.object({
  ...
  email: z.string().min(1, {
    ...
    message:'Please Enter the Vaild Email'
  }),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className='bg-slate-100 dark:bg-slate-500 border-0 focus-visible:ring-0 text-black dark:text-white focus-visible:ring-offset-0' placeholder="Enter ConfirmPassowrd" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
